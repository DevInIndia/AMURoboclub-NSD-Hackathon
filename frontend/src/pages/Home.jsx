...
function Home() {
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      if (!user) {
        setSearchedContent("Please login first to use this feature.");
        setIsLoading(false);
        return;
      }
        ...
        {!user ? (
          <div className="text-center text-white max-w-2xl">
            ...
            <p className="text-lg mb-6">
              Explore the mysteries of the universe, ask questions about space,
              and engage with a cosmic AI assistant. Sign in to begin your
